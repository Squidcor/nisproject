...
public class DiffieHellman {
    ...
    public DiffieHellman(Socket sock, int keyBitLength) {//Creates a new DH that with 'keyBitLength' key size. Needs a socket connection to the other party
        this.sock = sock;
        this.keyBitLength = keyBitLength;
        random = new SecureRandom();
    }

    public void initialise() {//Generates a prime and base which will the be shared with the other party, only one part must initialise
        prime = generatePrime();
        base = generateBase();
    }

    public void generateKeyPair() throws Exception {//Communicates with the other party and generates a public and private key pair accodring to the DH protocol
